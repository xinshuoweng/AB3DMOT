...
```
$ python3 main.py --cfg KITTI --split val --det_method pointrcnn --num_hypo 1
$ python3 trk_conf_threshold.py --result_sha pointrcnn_Car_val_H1
$ python3 visualization.py --result_sha pointrcnn_Car_val_H1 --split val
```
